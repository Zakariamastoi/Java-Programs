...
public class Time2Seconds
{
	...
	public Time2Seconds(int hour, int minute, int second)
	{
		...
		this.tSeconds = (grtHour*3600) + (getMinute*60) +getSecond; 
	}
	...
	public void setTime(int hour, int minute, int second)
	{
		...
		if (second < 0 || second >= 60)
		throw new IllegalArgumentException("second must be 0-59");
		this.tSeconds = (hour*3600)+(minute*60)+second;
	}
	...
	public void setHour(int hour )
	{
		if (hour < 0 || hour >= 24)
		throw new IllegalArgumentException("hour must be 0-23");
		tSeconds = (grtHour*3600) + (getMinute*60) +getSecond; 
	}
